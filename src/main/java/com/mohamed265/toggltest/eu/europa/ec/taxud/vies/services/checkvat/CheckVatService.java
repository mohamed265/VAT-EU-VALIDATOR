...
public class CheckVatService extends Service {
	...
	private final static QName CHECKVATSERVICE_QNAME = new QName(
			"urn:ec.europa.eu:taxud:vies:services:checkVat", "checkVatService");
	...
	public CheckVatPortType getCheckVatPort() {
		return super.getPort(
				new QName("urn:ec.europa.eu:taxud:vies:services:checkVat",
						"checkVatPort"), CheckVatPortType.class);
	}
	...
	public CheckVatPortType getCheckVatPort(WebServiceFeature... features) {
		return super.getPort(
				new QName("urn:ec.europa.eu:taxud:vies:services:checkVat",
						"checkVatPort"), CheckVatPortType.class, features);
	}
